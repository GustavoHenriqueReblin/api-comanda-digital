...
export const fakeProductData: Product[] = [
    { id: 1, idCategory: 1, name: "X-Burguer", price: 10, description: 'Caçador de estrelas em noites serenas.' },
    { id: 2, idCategory: 1, name: "X-Expecial", price: 12, description: 'Dançarino de palavras, criando poesia nos espaços em branco.' },
    { id: 3, idCategory: 2, name: "Água", price: 8.00, description: 'Arquiteto de risos, construindo pontes de alegria.' },
    { id: 4, idCategory: 1, name: "X-Salada", price: 16, description: 'Cenoura, rúcula e brócolis' },
